            ...
            <div className="w-full bg-LandingPageBK max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form className="space-y-6" action="#">
                    ...
                    <div className="flex items-start">
                        ...
                        <a href="/" className="ml-auto text-sm text-purple-700 hover:underline dark:text-pink-500">Lost Password?</a>
                    </div>
                    <button type="submit" className="w-full text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center" onClick={()=>navigate('doctordashboard')}>Login to your account</button>
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-300" >
                        Not registered? <Link to="/doctorsignup" className="text-purple-700 hover:underline dark:text-pink-500">Create account</Link>
                    </div>
                </form>
            </div>
            </div>
