    ...
    return (
        <div className=' px-28 bg-LandingPageBK '>
            ...
            <div className='relative flex items-center flex-col '>
                <h1 className='text-2xl text-white h-9 w-full text-center m-14'>
                    OR
                </h1>
                <button type="button" className=" text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-14">
